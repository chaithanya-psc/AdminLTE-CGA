...
namespace QconzLocate
{
    public class BundleConfig
    {
        ...
        private static void RegisterAgency(BundleCollection bundles)
        {

            bundles.Add(new ScriptBundle("~/Scripts/Bundle/Agency/Data").Include(
                "~/Scripts/Agency/Data.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Bundle/Agency/Agency/menu").Include(
                "~/Scripts/Agency/Agency-menu.js"));
